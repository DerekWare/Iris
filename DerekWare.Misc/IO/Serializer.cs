...
namespace DerekWare.IO
{
    ...
    {
        public static T DeserializeFile<T>(this IStreamDeserializer<T> serializer, Path fileName, FileMode fileMode = FileMode.Open, FileAccess fileAccess = FileAccess.Read)
        {
        ...
        public static void SerializeFile<T>(this IStreamSerializer<T> serializer, T obj, Path fileName, FileMode fileMode = FileMode.Create, FileAccess fileAccess = FileAccess.Write)
        {
            using(var stream = new FileStream(fileName, fileMode, fileAccess))
            {
